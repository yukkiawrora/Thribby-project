                            ...
                            <div class="col-md-12">    
                                ...
                                <div class="portlet box red">
                                    <div class="portlet-title">
                                        <div class="caption">Driver List</div>
                                        
                                            <div class="actions">
                                                <a class="btn danger-btn btn-sm" href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name ?>/add/driver"><i class="fa fa-plus"></i> Add</a>
                                            </div>
