...
if($this->input->post()){
  ...
  $FieldsArray = array('entity_id','name','phone_number','email','capacity','no_of_table','no_of_hall','hall_capacity','address','landmark','latitude','longitude','state','country','city','zipcode','amount_type','amount','enable_hours','timings','image','is_veg','driver_commission');
